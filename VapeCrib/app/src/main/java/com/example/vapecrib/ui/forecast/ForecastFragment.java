...
public class ForecastFragment extends Fragment {
    ...
    private void populateDropdowns() {
        ...
        ArrayAdapter<String> productAdapter = new ArrayAdapter<>(
            requireContext(), android.R.layout.simple_dropdown_item_1line, ForecastViewModel.PRODUCT_LIST);
        binding.actvProduct.setAdapter(productAdapter);
        // No default product — hint shows "All Products (Aggregated)" until user types
