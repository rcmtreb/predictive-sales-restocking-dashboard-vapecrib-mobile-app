...
public class SaleApiRecord {
    ...
    /**
     * Full ISO datetime string from Flask's sale_date.isoformat(),
     * e.g. "2025-03-01T14:23:45.000000". Use {@code date.substring(0,10)}
     * before passing to {@link java.time.LocalDate#parse(CharSequence)}.
     */
