...
/**
 * Paged wrapper for GET /api/mobile/forecast.
 * Flask _ok() nests pagination under a "pagination" key.
 */
public class PagedForecastResponse {

    @SerializedName("data")
    private List<ForecastApiRecord> data;

    @SerializedName("pagination")
    private Pagination pagination;

    public List<ForecastApiRecord> getData() { return data; }
